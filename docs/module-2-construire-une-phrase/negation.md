...
**Prérequis :** [Les pronoms personnels](./pronoms-personnels)
...
<div class="mt-4 grid gap-3">
  ...
  <div class="p-4 rounded-xl border border-orange-200 bg-orange-50">
    <div class="font-bold text-orange-800 text-lg">kein / keine / kein</div>
    <div class="text-sm text-orange-700 mt-1">Nie un nom avec article indefini (ein) ou sans article</div>
    <div class="text-sm text-gray-600 mt-2">= "pas de" / "aucun"</div>
  </div>

</div>

## nicht - la negation de l'action ou de l'adjectif

### Nier le verbe

*Nicht* se place **en fin de phrase** quand il nie l'ensemble de l'action :

- *Ich arbeite.* → *Ich arbeite **nicht**.* - Je ne travaille pas.
- *Er kommt.* → *Er kommt **nicht**.* - Il ne vient pas.
- *Sie schläft.* → *Sie schläft **nicht**.* - Elle ne dort pas.
...
- *Ich lese die Zeitung.* → *Ich lese **nicht** die Zeitung.* - Je ne lis pas le journal.
  ...
  <table class="w-full text-sm">
    ...
    <tbody>
      <tr class="border-t border-gray-100">
        <td class="p-3 font-medium">ein →</td>
        <td class="p-3 text-center font-bold text-blue-700">kein</td>
        <td class="p-3 text-center font-bold text-red-600">keine</td>
        <td class="p-3 text-center font-bold text-green-700">kein</td>
        <td class="p-3 text-center font-bold text-gray-700">keine</td>
      </tr>
    </tbody>
  </table>
</div>
...
- *Ich habe ein Auto.* → *Ich habe **kein** Auto.* - Je n'ai pas de voiture.
...
<div class="mt-4 p-5 rounded-xl border border-green-200 bg-green-50">
  <div class="font-semibold text-green-800 mb-3">Question a se poser : est-ce qu'il y a un article *ein* (ou pas d'article) devant le nom ?</div>
