...
<div class="mt-4 grid gap-3">
  ...
  <div class="p-4 rounded-lg border border-gray-200">
    <div class="font-semibold text-gray-900">Ich heiße [prenom].</div>
    <div class="text-sm text-gray-500 mt-1">Je m'appelle [prenom]. - la forme la plus courante a l'oral</div>
  </div>
  ...
  <div class="p-4 rounded-lg border border-gray-200">
    <div class="font-semibold text-gray-900">Mein Name ist [prenom].</div>
    <div class="text-sm text-gray-500 mt-1">Mon nom est [prenom]. - plus formel, souvent a l'ecrit</div>
  </div>
...
<div class="mt-4 p-4 rounded-lg border border-green-200 bg-green-50">
  ...
  <div class="text-sm text-gray-600 mt-1">J'ai [nombre] ans. - litteralement "je suis [nombre] ans vieux"</div>
...
On dit simplement *Ich bin* + la profession, **sans article** (contrairement au français).

::: warning Pas d'article devant la profession
En français on dit "je suis **un** professeur". En allemand on dit *Ich bin Lehrer* - sans *ein*. Ajouter l'article serait une erreur typique de francophone.
:::
