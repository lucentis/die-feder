...
<div class="mt-6 grid grid-cols-3 gap-4">
  ...
  <div class="p-4 rounded-xl border-2 border-blue-200 bg-blue-50 text-center">
    <div class="text-3xl font-black text-blue-600">der</div>
    <div class="font-semibold text-gray-700 mt-2">Masculin</div>
    <div class="text-sm text-gray-500 mt-1">der Mann (l'homme)<br>der Tisch (la table)<br>der Hund (le chien)</div>
  </div>
  ...
  <div class="p-4 rounded-xl border-2 border-green-200 bg-green-50 text-center">
    <div class="text-3xl font-black text-green-600">das</div>
    <div class="font-semibold text-gray-700 mt-2">Neutre</div>
    <div class="text-sm text-gray-500 mt-1">das Kind (l'enfant)<br>das Auto (la voiture)<br>das Buch (le livre)</div>
  </div>
...
<div class="mt-4 grid gap-2">
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-blue-600 w-24 shrink-0">-er (agent)</div>
    <div class="text-sm text-gray-600">Noms formes a partir d'un verbe : <em>der Lehrer</em> (enseignant), <em>der Fahrer</em> (conducteur), <em>der Backer</em> (boulanger)</div>
  </div>
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-blue-600 w-24 shrink-0">-ig / -ich</div>
    <div class="text-sm text-gray-600"><em>der Honig</em> (miel), <em>der Konig</em> (roi), <em>der Teppich</em> (tapis)</div>
  </div>
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-blue-600 w-24 shrink-0">-ling</div>
    <div class="text-sm text-gray-600"><em>der Frühling</em> (printemps), <em>der Lehrling</em> (apprenti)</div>
  </div>
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-blue-600 w-24 shrink-0">-ismus</div>
    <div class="text-sm text-gray-600"><em>der Kapitalismus</em>, <em>der Tourismus</em></div>
  </div>
</div>
...
<div class="mt-4 grid gap-2">
  ...
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    ...
    <div class="text-sm text-gray-600"><em>die Freundschaft</em> (amitie), <em>die Gesellschaft</em> (societe)</div>
  </div>
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-red-500 w-24 shrink-0">-tion / -sion</div>
    <div class="text-sm text-gray-600"><em>die Nation</em>, <em>die Lektion</em>, <em>die Mission</em></div>
  </div>
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-red-500 w-24 shrink-0">-in (personne)</div>
    <div class="text-sm text-gray-600"><em>die Lehrerin</em> (professeure), <em>die Ärztin</em> (medecin femme)</div>
  </div>
</div>
...
<div class="mt-4 grid gap-2">
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    <div class="font-bold text-green-600 w-24 shrink-0">-chen / -lein</div>
    <div class="text-sm text-gray-600">Regle absolue - les diminutifs sont toujours neutres : <em>das Mädchen</em> (la fille), <em>das Häuschen</em> (la petite maison)</div>
  </div>
...
:::
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
    ...
    <div class="text-sm text-gray-600"><em>das Instrument</em>, <em>das Dokument</em>, <em>das Experiment</em></div>
  </div>
  <div class="flex items-start gap-3 p-3 rounded-lg border border-gray-200">
...
Quel que soit le genre au singulier, l'article au pluriel est toujours **die**.
